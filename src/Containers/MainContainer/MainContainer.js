...
//                         </div>
//                         <div className="nav-item" onClick={() => (handleClickNavOptions)(MainContainerTypes.SETTINGS_TYPE)}>  <p className="navIconLayout"> <IoSettingsOutline className="navIcon"/>
//                         </p>
...
const MainContainer = ({ Children }) => {
    ...
    const fakeUser = {
        userId: 1,
        user: 'Apoorva',
        email: 'Apoorva.hr@ideassison.com'
    };
    const getFirstLetter = str => {
        return str.charAt(0).toUpperCase();
    }
        ...
        <div className="main-container">
            <div className="navbar">
                ...
                <div className="navBottom">
                    ...
                    <div>
                        {/* {userDetail.map(user => ( */}
                        <div key={fakeUser.userId} className="navBottomTwo">
                            <div className="mailLogoLayout"><p className="mailLogo">
                                {getFirstLetter(fakeUser.user)}
                            </p></div>
                            <div className="mailName">
                                <p>{fakeUser.user}</p>
                                <p style={{ color: '#71839B' }}>{fakeUser.email}</p>
                            </div>
                        </div>
                        {/* ))} */}
                    </div>
